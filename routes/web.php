...
Route::get('categoryrooms-deleted', [CategoryRoomController::class, 'deleted'])->name('categoryrooms.deleted');
...
Route::get('user-deleted', [UserController::class, 'deleted'])->name('user_deleted');
