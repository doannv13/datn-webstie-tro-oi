...
class PaymentVNPayController extends Controller
{
    ...
    public function payment_vnpay()
    {
        ...
        $vnp_Returnurl = "http://127.0.0.1:8000/notification_pay"; // url redirect sau khi thanh toán xong
        ...
        $vnp_TxnRef = 4; //Mã đơn hàng. Trong thực tế Merchant cần insert đơn hàng vào DB và gửi mã này sang VNPAY
