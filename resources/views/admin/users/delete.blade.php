    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="mt-0">Danh sách tài khoản đã xóa</h5>
                        <div class="table-responsive">
                            <div class="mb-2 d-flex gap-1 ">
                                <a class="btn btn-success" href="{{ route('users.index') }}">Danh sách tài khoản</a>
                            </div>
                                ...
                                @foreach ($data as $key => $value)
                                    <tr id="row_@item.ID">
                                        ...
                                        <td class="">
                                            ...
                                            <form action="{{ route('users-permanently-delete', $value->id) }}" method="POST">
                                                @csrf
                                                @method('delete')
