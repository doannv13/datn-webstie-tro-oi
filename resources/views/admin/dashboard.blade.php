                    ...
                    <div class="card-body widget-user">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 avatar-lg me-3">
                                <img src="{{asset('be/assets/images/users/user-3.jpg')}}" class="img-fluid rounded-circle" alt="user">
                            </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card">
                    <div class="card-body widget-user">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 avatar-lg me-3">
                                <img src="{{asset('be/assets/images/users/user-2.jpg')}}" class="img-fluid rounded-circle" alt="user">
                            </div>
                            <div class="flex-grow-1 overflow-hidden">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card">
                    <div class="card-body widget-user">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 avatar-lg me-3">
                                <img src="{{asset('be/assets/images/users/user-1.jpg')}}" class="img-fluid rounded-circle" alt="user">
                            </div>
                            <div class="flex-grow-1 overflow-hidden">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card">
                    <div class="card-body widget-user">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0 avatar-lg me-3">
                                <img src="{{asset('be/assets/images/users/user-10.jpg')}}" class="img-fluid rounded-circle" alt="user">
                            </div>
                            <div class="flex-grow-1 overflow-hidden">
                    ...
                    <div class="card-body">
                        ...
                        <div class="inbox-widget">
                            ...
                            <div class="inbox-item">
                                <a href="#">
                                    <div class="inbox-item-img"><img src="{{asset('be/assets/images/users/user-1.jpg')}}" class="rounded-circle" alt=""></div>
                            ...
                            <div class="inbox-item">
                                <a href="#">
                                    <div class="inbox-item-img"><img src="{{asset('be/assets/images/users/user-2.jpg')}}" class="rounded-circle" alt=""></div>
                            ...
                            <div class="inbox-item">
                                <a href="#">
                                    <div class="inbox-item-img"><img src="{{asset('be/assets/images/users/user-3.jpg')}}" class="rounded-circle" alt=""></div>
                            ...
                            <div class="inbox-item">
                                <a href="#">
                                    <div class="inbox-item-img"><img src="{{asset('be/assets/images/users/user-4.jpg')}}" class="rounded-circle" alt=""></div>
                            ...
                            <div class="inbox-item">
                                <a href="#">
                                    <div class="inbox-item-img"><img src="{{asset('be/assets/images/users/user-5.jpg')}}" class="rounded-circle" alt=""></div>
