                        ...
                        <tr class="al">
                            ...
                            <td>
                                ...
                                <div class="statusSelect" name="status" data-id="{{ $value->id }}">
                                    <label class="btn {{ $value->status == 'accept' ? 'btn-success' : 'btn-danger' }}" for="">{{ $value->status === 'accept' ? 'Đã kích hoạt' : 'Đã huỷ' }}</label>
                                </div>
                                @endif
                            </td>
                            ...
                            <td class="">
                                <div class="d-flex">
                                    ...
                                    <a href="{{ route('admin-room-posts.edit', $value->id) }}">
                                        <button type="submit" class="btn btn-primary text-center my-1" style="width: 45px;">
