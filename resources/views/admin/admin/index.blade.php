        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="mt-0">Danh sách admin</h5>
                            <div class="table-responsive">
                                <div class="mb-2 d-flex gap-1 ">
                                    <a class="btn btn-success" href="{{ route('admins.create') }}">Thêm mới</a>
                                    <a class="btn btn-danger" href="{{ route('admins-deleted') }}">Thùng rác</a>
                                </div>
