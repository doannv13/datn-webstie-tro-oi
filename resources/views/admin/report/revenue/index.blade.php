...
@section('content')
    ...
    <div class="row">
        <div class="d-flex justify-content-between align-items-center">
            <form class="d-flex gap-2 mb-4" action="{{ 'admin-report-revenue' }}" method="post">
                @csrf
                @method('post')
                <div class="mt-1">
                ...
                <div class="card-body">
                    ...
                    <div class="widget-box-2">
                        <div class="widget-detail-2 text-end">
                            <span class="badge bg-success rounded-pill float-start mt-3"> {{ number_format($bill) }}<i
                        ...
                        <div class="progress progress-bar-alt-success progress-sm">
                            <div class="progress-bar bg-success" role="progressbar" aria-valuenow="{{ $bill_false }}"
                                aria-valuemin="0" aria-valuemax="{$bill}}"
                                style="width: @if ($bill != 0) {{ 100 - ($bill_false % $bill) }}@else 0 @endif%;">
        ...
        <div class="">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title mt-0 mb-3">Doanh thu tổng quan</h4>
