                        ...
                        <div class="slick row comon-slick-inner wow fadeInUp delay-04s"
                            ...
                            <div class="item slide-box">
                                <div class="staff-box-4">
                                    <div class="item">
                                        <div class="thumb">
                                            <img src="{{ asset('fe/img/avatar/doannv.jpg') }}" alt="staff"
                                                class="img-fluid w-100" style="width:300px; height:375px;" />
                                            <div class="info">
                                                <h4>Nguyễn Đoàn</h4>
                            ...
                            <div class="item slide-box">
                                <div class="staff-box-4">
                                    <div class="item">
                                        <div class="thumb">
                                            <img src="{{ asset('fe/img/avatar/congtv.jpg') }}" alt="staff"
                                                class="img-fluid w-100" style="width:300px; height:375px;" />
                                            <div class="info">
                                                <h4>Trần Công</h4>
                            ...
                            <div class="item slide-box">
                                <div class="staff-box-4">
                                    <div class="item">
                                        <div class="thumb">
                                            <img src="{{ asset('fe/img/avatar/anhnt.jpg') }}" alt="staff"
                                                class="img-fluid w-100" style="width:300px; height:375px;" />
                                            <div class="info">
                                                <h4>Tuấn Anh</h4>
                                                <span>Đồng sáng lập</span>
                            ...
                            <div class="item slide-box">
                                <div class="staff-box-4">
                                    <div class="item">
                                        <div class="thumb">
                                            <img src="{{ asset('fe/img/avatar/nguyennk.jpg') }}" alt="staff"
                                                class="img-fluid w-100" style="width:300px; height:375px;" />
                                            <div class="info">
                                                <h4>Khánh Nguyên</h4>
                                                <span>Đồng sáng lập</span>
                            ...
                            <div class="item slide-box">
                                <div class="staff-box-4">
                                    <div class="item">
                                        <div class="thumb">
                                            <img src="{{ asset('fe/img/avatar/vietnq.jpg') }}" alt="staff"
                                                class="img-fluid w-100  " style="width:300px; height:375px;" />
                                            <div class="info">
                                                <h4>Quốc Việt</h4>
                                                <span>Đồng sáng lập</span>
                            ...
                            <div class="item slide-box">
                                <div class="staff-box-4">
                                    <div class="item">
                                        <div class="thumb">
                                            <img src="{{ asset('fe/img/avatar/thaolm.jpg') }}" alt="staff"
                                                class="img-fluid w-100  " style="width:300px; height:375px;" />
                                            <div class="info">
                                                <h4>Lê Minh Thảo</h4>
                                                <span>Đồng sáng lập</span>
                            ...
                            <div class="item slide-box">
                                <div class="staff-box-4">
                                    <div class="item">
                                        <div class="thumb">
                                            <img src="{{ asset('fe/img/avatar/phucnq.jpg') }}" alt="staff"
                                                class="img-fluid w-100  " style="width:300px; height:375px;" />
                                            <div class="info">
                                                <h4>Quang Phúc</h4>
                                                <span>Đồng sáng lập</span>
