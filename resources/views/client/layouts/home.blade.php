                ...
                <div class="slick row comon-slick-inner wow fadeInUp delay-04s"
                    ...
                    <div class="item slide-box">
                        <div class="staff-box-4">
                            <div class="item">
                                <div class="thumb">
                                    <img src="{{ asset('fe/img/staff/img-5.jpg') }}" alt="staff"
                    ...
                    <div class="item slide-box">
                        <div class="staff-box-4">
                            <div class="item">
                                <div class="thumb">
                                    <img src="{{ asset('fe/img/staff/img-6.jpg') }}" alt="staff"
                                        class="img-fluid w-100" />
                                    <div class="info">
                                        <h4>Karen Paran</h4>
                    ...
                    <div class="item slide-box">
                        <div class="staff-box-4">
                            <div class="item">
                                <div class="thumb">
                                    <img src="{{ asset('fe/img/staff/img-8.jpg') }}" alt="staff"
                                        class="img-fluid w-100" />
                                    <div class="info">
                                ...
                                <div class="blog-1">
                                    ...
                                    <div class="detail">
                                        <div class="post-meta clearfix">
                                            <ul>
                                                <li>
                                                    <strong><a href="{{ route('posts-detail', $value->id) }}">By: <span
