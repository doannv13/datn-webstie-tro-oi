                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select mb-3" id="city" name="city_id">
                                    ...
                                    @foreach ($cities as $city)
                                        <option value="{{ $postroom->city_id }}"
                                            {{ old('city_id') == $postroom->city_id || $city->id == $postroom->city_id ? 'selected' : '' }}>
                                            {{ $city->name }}</option>
                                    @endforeach
                                </select>
                                @error('city_id')
                            ...
                            <div class="form-group ">
                                ...
                                <select class="form-select  mb-3" id="district" name="district_id">
                                    @foreach ($districts as $district)
                                        <option value="{{ $postroom->district_id }}"
                                            {{ old('district_id') == $postroom->district_id || $district->id == $postroom->district_id ? 'selected' : '' }}>
                            ...
                            <div class="form-group ">
                                ...
                                <select class="form-select mb-3" name="ward_id" id="ward">
                                    @foreach ($wards as $ward)
                                        <option value="{{ $postroom->ward_id }}"
                                            {{ old('ward_id') == $postroom->ward_id || $ward->id == $postroom->ward_id ? 'selected' : '' }}>
                                            {{ $ward->name }}</option>
                                    @endforeach
                                </select>
                                @error('ward_id')
